...
@section('content')
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Изменение категории</h3>
                </div>
                <div class="col-sm-6">
                    ...
                    <form method="post" action="{{ route('admin.category.update', $category) }}">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input value="{{ old('title') ?? $category->title }}" name="title" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="meta_desc" id="meta_desc"
                                          ...
                                          aria-label="With textarea">{{ old('meta_desc') ?? $category->meta_desc }}</textarea>
                                @error('meta_desc')
